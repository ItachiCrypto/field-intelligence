...
export const NEED_CATEGORIES: CategoryRule[] = [
  ...
  },
  {
    id: 'documentation',
    label: 'Documentation',
    description: 'Carnets de suivi, fiches patient, données cliniques, études',
    badgeClass: 'bg-sky-50 text-sky-700 border-sky-200',
    hex: '#0ea5e9',
    patterns: [
      /\bcarnet(s)?\b/i,
      /\bfiche(s)?\s+(patient|produit|technique)/i,
      /\bbrochure(s)?\b/i,
      /\bdocumentation\b/i,
      /\bdocument(s|aire)?\b/i,
      /\bdonnees?\s+(cliniques?|terrain)/i,
      /\betudes?\s+(cliniques?|sur|de|patients?)/i,
      /\bsupport(s)?\s+(papier|patient|etudiant|comm)/i,
  ...
  },
  {
    ...
    description: 'Arguments de vente, accompagnement deal, pricing, contrats',
    badgeClass: 'bg-rose-50 text-rose-700 border-rose-200',
    hex: '#e11d48',
    patterns: [
      /\bargument(s|aire)?\b/i,
      /\baccompagnement\s+(senior|patient|vente|equipe)/i,
      /\bnegociat\w+/i,
      /\boffre\s+(special|af|commerciale)/i,
      /\bremise\b/i,
      ...
      /\brepositionn\w+/i,
      /\bprevisionnel\b/i,
      /\bcommande\s+(addi|additionnel|complementaire)/i,
      /\bcontrat\b/i,
      /\bdeal\b/i,
      /\bRFA\b/i,
      /\bgroupement\b/i,
      /\bpack\s+(initiation|tout-en-un|complet)/i,
      /\bbundle\b/i,
      /\bcapillaire\b/i,
      /\brentabilit(e|y)\b/i,
      /\bmarge\b/i,
