    ...
    <div className="flex flex-1 items-center justify-center p-8 bg-slate-50 min-h-screen">
      <div className="w-full max-w-lg">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div>
            <label htmlFor="businessContext" className="block text-sm font-medium text-slate-700 mb-1">
              Que fait votre entreprise ?
            </label>
            <p className="text-xs text-slate-500 mb-2 leading-relaxed">
              Décrivez votre activité en détail : secteur, produits/services, clientèle cible,
              concurrents principaux, particularités du marché. Plus c'est précis, mieux notre IA
              comprendra le contexte de vos comptes rendus.
            </p>
            <textarea
              id="businessContext"
              ...
              rows={6}
              className="w-full px-3 py-2 text-sm bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-slate-900 placeholder:text-slate-400 resize-y leading-relaxed"
              placeholder="Ex : Nous distribuons du matériel de diagnostic glycémique aux pharmacies françaises. Nos commerciaux visitent ~200 pharmacies/mois en région IDF, Sud-Est et Ouest. Nos principaux concurrents sont Abbott, Dexcom et Ypsomed. Le cycle de vente moyen est de 45 jours. Nos KPIs prioritaires : PDM, rotation B7/K7/L7, signature offre AF."
            />
          </div>
          <div>
